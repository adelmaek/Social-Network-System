 ...
 */
 ...
 class Post {
   ...
   // Button viewComments;
    ...
    public void setPostComments(Vector<Comment> postComments) {
    ...
    public void setDislike(Vector<String> dislike) {
        this.dislike = dislike;
    }

    public void setNumbOfDislikes(int numbOfDislikes) {
        this.numbOfDislikes = numbOfDislikes;
    }
    ...
    public Comment getPostComment(int i) {
        return postComments.get(i);
    }

    public Vector<Comment> getPostComments() {
        return postComments;
    }
    ...
    public String getDislike(int i) {
        return dislike.get(i);
    }

    public int getNumbOfDislikes() {
        return numbOfDislikes;
    }
